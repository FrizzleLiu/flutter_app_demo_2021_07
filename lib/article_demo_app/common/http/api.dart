...
class Api {
  ...
  static login(String username,String password) async {
    var formData = FormData.fromMap({"username": username,"password":password});
  ...
  static getCollects(int page) async{
    return await HttpManager.getInstance().request('$COLLECT_ARTICLE_LIST$page/json');
  }

  static register(String username,String password) async{
    var formData = FormData.fromMap({"username": username,"password":password,"repassword":password});
